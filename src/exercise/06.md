...
```jsx
console.dir(event.target) // Shows properties
```

When we use useRef(), we get a ref to the DOM node for the element.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=kdaviduik%40gmail.com).
